...
/**
   num_powers. The number of H-powers generated. GHASH over a maximum-size TLS
   1.3 record needs 1 AAD block + 1025 ciphertext blocks + 1 length block =
   1027 powers; 1088 is the next multiple of 64 above that.
**/
inline constexpr auto num_powers = 1088;
...
inline constexpr auto l =
    (use_multiplicative_shares) + (num_powers - 2) / (use_multiplicative_shares + 1);
...
**/
using ShareType = InnerType<num_powers>;
