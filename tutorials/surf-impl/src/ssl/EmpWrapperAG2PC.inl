...
inline uint64_t EmpWrapperAG2PC::get_round_counter() const noexcept {
  return wrapper.get_round_counter();
}

inline bool EmpWrapperAG2PC::has_io_failed() const noexcept {
  return wrapper.has_io_failed();
}
