...
inline void RWCounter::track_round() noexcept { round_counter += 1; }
inline std::size_t RWCounter::get_rounds() const noexcept {
  return round_counter;
}
inline void RWCounter::reset_rounds() noexcept { round_counter = 0; }
...
constexpr inline void NoCounter::track_round() noexcept {}
constexpr inline std::size_t NoCounter::get_rounds() noexcept { return 0; }
constexpr inline void NoCounter::reset_rounds() noexcept {}
